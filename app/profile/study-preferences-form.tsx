...
export default function StudyPreferencesForm({ user, onSuccess }: StudyPreferencesFormProps) {
                ...
                <Checkbox
                  ...
                  onCheckedChange={(checked) => {
                    if (checked) {
                      ...
                      form.setValue("targetExam", currentExams.filter((e) => e !== exam.id));
                    }
                  }}
                  className="sr-only"
                />
        ...
        <div className="space-y-2.5">
          ...
          <div className="relative">
            ...
            <Select
              ...
              onValueChange={(val) => form.setValue("dailyStudyTime", val as "LESS_THAN_2_HOURS" | "TWO_TO_FOUR_HOURS" | "MORE_THAN_4_HOURS")}
            >
              <SelectTrigger className="rounded-2xl pl-10 bg-muted/30 border-transparent hover:bg-muted/50 focus:bg-background focus:border-primary transition-all h-12">
