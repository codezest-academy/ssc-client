  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      <div className="flex items-center gap-2 mb-2">
        <Link href="/dashboard/practice-sets" className="text-muted-foreground hover:text-foreground transition-colors text-sm font-medium flex items-center">
      ...
      <div className="text-center space-y-4 py-8">
        ...
        <h1 className="text-4xl font-bold text-foreground tracking-tight">{practiceSet.title}</h1>
      ...
      {(!practiceSet.isFree && (!user || user.subscriptionTier === "FREE")) ? (
        ...
        <div className="bg-white border border-border rounded-2xl p-8 shadow-sm text-center">
          <h3 className="text-xl font-semibold mb-4 text-foreground">Ready to begin?</h3>
          ...
          {questionCount === 0 && (
            <p className="text-destructive text-sm mt-4">This practice set has no questions yet.</p>
          )}
        </div>
      )}
    </div>
