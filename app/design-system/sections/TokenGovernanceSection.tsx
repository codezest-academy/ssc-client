...
export function TokenGovernanceSection() {
  return (
    <div className="space-y-12 mb-16">
      ...
      {/* ESLint Rule */}
      <div className="bg-muted/30 border-none rounded-3xl p-6 flex flex-col sm:flex-row gap-6 items-center shadow-xl hover:-translate-y-1 hover:shadow-2xl transition-all">
